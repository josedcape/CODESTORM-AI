    ...
    try:
        ...
        if is_complex_file_request and not is_file_operation:
            try:
                ...
                # Llamar al endpoint para generar el archivo complejo usando el agente seleccionado
...
# Función interna para generar archivos complejos sin usar el endpoint HTTP
